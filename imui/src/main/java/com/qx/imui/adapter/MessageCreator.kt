...
class MessageCreator {
    ...
    fun createRecordMessage(conversationType: String, senderId: String, targetId: String, messages: List<Message>, extra: String): Message {
        var recordMessage = RecordMessage(messages, extra)
        recordMessage.extra = extra
        return Message.obtain(senderId, targetId, conversationType, MessageType.TYPE_RECORD, recordMessage)
    }
